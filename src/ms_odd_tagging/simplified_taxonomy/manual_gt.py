...
<div id="timelineWrap"><div id="timelineMeta"><span>Recording timeline</span><span id="timelineLabel"></span></div><input id="timeline" type="range" min="0" max="0" value="0" step="1" aria-label="Recording frame timeline" oninput="scrub(Number(this.value))"></div>
