...
function renderLabels(){{
  ...
  for(const definition of DATA.scenario_groups){{
    ...
    details.open=definition.implemented!==false;
    ...
    for(const label of definition.scenarios){{
