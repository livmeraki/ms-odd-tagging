...
def plot_speed(
    ...
    plt.plot(time_since_start, adjacent_speed, marker="o", markersize=2, linewidth=1, label="adjacent difference")
    plt.plot(time_since_start, derivative_speed, marker=".", markersize=2, linewidth=1, label="central derivative")
