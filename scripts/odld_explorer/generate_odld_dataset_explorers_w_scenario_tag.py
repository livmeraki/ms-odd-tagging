...
from odld_explorer_common import (
    existing_rows_by_recording as _existing_rows_by_recording,
    explorer_output_name,
    format_elapsed,
    index_html,
    inject_lane_tracker,
    read_manifest_rows,
    rebuild_rows_from_outputs as _rebuild_rows_from_outputs,
...
def existing_rows_by_recording(output_dir: Path) -> dict[str, dict]:
    return _existing_rows_by_recording(output_dir, row_parser=row_from_explorer)
...
def rebuild_rows_from_outputs(
    ...
    return _rebuild_rows_from_outputs(
        output_dir,
        rows_by_recording,
...
def main() -> None:
    ...
    canonical_paths = select_canonical_paths(args.canonical_dir, args.recordings)
