...
It keeps the same inputs and outputs, but exposes the expensive per-recording
...
STAGE_NAMES = (
    ...
    "run/load rule-based scenario events",
...
def main() -> None:
    ...
    for canonical_path in canonical_paths:
        ...
        progress.complete(
            f"{len(data['tags'].get('events', []))} rule/event intervals"
        )
